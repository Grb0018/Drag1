let vw = screen.availWidth/100;
 ...
 document.body.ontouchstart = (e)=>{
    if(e.target== document.getElementsByClassName('ring1')[0]){
am0()
    }
    if(e.target== document.getElementsByClassName('ring2')[0]){
        am1()
            }
            if(e.target== document.getElementsByClassName('ring3')[0]){
              am2();
            }
            if(e.target== document.getElementsByClassName('ring4')[0]){
              am3();
            }
            if(e.target== document.getElementsByClassName('ring5')[0]){
              am4();
            }
            if(e.target== document.getElementsByClassName('ring6')[0]){
              am5();
            }
            if(e.target== document.getElementsByClassName('ring7')[0]){
              am6();
            }
            if(e.target== document.getElementsByClassName('ring8')[0]){
              am7();
            }        
    }
